...
urlpatterns = [
    ...
    path('lab11/part2/add/', views.add_student3, name='users.add_student'),
    path('lab11/part2/edit/<int:id>/', views.edit_student3, name='users.edit_student'),
    path('lab11/part2/delete/<int:id>/', views.delete_student3, name='users.delete_student'),
